...
def filter_posts(relevant_tags):
    """
    Filtra Posts.xml com base nas tags e no intervalo de datas.
    """
    ...
    print(f"Posts.xml processado. {count} posts relevantes salvos em '{output_file}'.")
